(function() {
	...
	// SUCCES
	if (typeof(Storage) !== "undefined" && localStorage.getItem('movieApp.content.movies') !== null) {		// Check of local storage mogelijk is in de browser EN is localStorage.getItem('movieApp.content.movies' gevuld?
		...
		console.log("Local storage is gelukt.");															// Feedback in console (succes).
	...
	// FAIL	
		...
		console.log("Local storage is mislukt.");															// Feedback in console (fail).
	}
...
// PROBLEEM: als hij API niet kan laden, hoe kan ik dan mijn eigen content laten zien?
// VRAAG: moet "console.log(movieApp.content.movies);" niet document.write zijn?	
