	...
	movieApp.sections = {
		...
		toggle: function(section, subPage, argument) {
			...
			for (var i = 0; i < selector.length; i++) {
				// Verwijder bij alle <section> de CSS class "active" en "detail"
			...
			*/
			...
			// Als de doorgestuurde <section> "movies" is dan zijn er drie opties:
				...
				// NUMMER 2: Als er een subPage doorgestuurd is en deze subPagina 'detail' is
					...
					document.getElementById("detail").classList.add("active"); // display: block;
					document.getElementById(section).classList.add("detail"); // width: 100%
				}
